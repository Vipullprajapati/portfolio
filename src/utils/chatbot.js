...
export const responses = {
  ...
  projects:
    "He have worked on some projects which includes phrasepics, weatherapp,react news app .",
  contact: "You can reach him at connectwithsubbu@gmail.com or on LinkedIn.",
  name: "I am Subot",
  education:
    "Completed B.E. in Information Science and Engineering from Visvesvaraya Technological university",
};
